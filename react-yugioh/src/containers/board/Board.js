                    ...
                    <div>
                        <Spell_field
                            spell_field={this.props.spell_field2.map((spell) => {
                                return(
                                    <img className="col-sm-1 player2 card" height="100" width="68" src={spell.image_url}/>
                                )
                            })}
                    ...
                    <div>
                        <Monster_field
                            monster_field={this.props.monster_field2.map((monster) => {
                                return(
                                    <img onClick={this.props.main_phase1_2} className="col-sm-1 player2 card" height="100" width="68" src={monster.image_url}/>
                                )
                            })}
                        ...
                        <Monster_field
                            monster_field={this.props.monster_field1.map((monster) => {
                                return(
                                    ...
                                    <img onClick={this.props.main_phase1_2} className="col-sm-1 player1 card" height="100" width="68" src={monster.image_url}/>
                                        : <img onClick={this.props.main_phase1_2} className="col-sm-1 player1 card" height="68" width="100" src={"http://vignette3.wikia.nocookie.net/yugioh/images/6/68/Face_Down_Defense_Position.png/revision/latest?cb=20100726091546"}/>
                                )
                            })}
                    ...
                    <div>
                        <Spell_field
                            spell_field={this.props.spell_field1.map((spell) => {
                                return(
                                    <img className="col-sm-1 player1 card" height="100" width="68" src={"https://i.pinimg.com/originals/ed/b7/02/edb702c8400d4b0c806d964380b03b6a.jpg"}/>
                                )
                            })}
